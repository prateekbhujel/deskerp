...
@section('content')
    <section class="dp-section">
        <div class="dp-toolbar">
            <div>
                <h1 class="dp-title">Customer Ledger</h1>
                <p class="dp-subtitle">{{ $customer->name }}</p>
            </div>
            <a href="{{ route('reports.customers.ledger', [$customer, 'export' => 'csv'] + request()->query()) }}" class="dp-btn-primary">Export CSV</a>
        </div>
        ...
        <form method="GET" class="dp-card p-4">
            <div class="grid gap-4 md:grid-cols-[1fr_1fr_auto]">
                ...
                <div class="flex items-end gap-3">
                    ...
                    <a href="{{ route('reports.customers.ledger', $customer) }}" class="dp-btn">Reset</a>
                </div>
            </div>
        </form>
