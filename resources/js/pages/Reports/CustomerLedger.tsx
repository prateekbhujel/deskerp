...
export default function CustomerLedger({ customer, ledger, filters }: CustomerLedgerProps) {
    ...
    const applyFilters = (nextPage = 1) => {
        router.get(
            paths.reports.customerLedger(customer.id),
            {
                ...localFilters,
                page: nextPage,
            },
    ...
    return (
        <AppShell title={`Customer Ledger: ${customer.name}`} subtitle="Running balance with CSV/XLSX export." activeKey="reports">
